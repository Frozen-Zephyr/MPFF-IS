...
# 定义三个XVG文件路径和对应的标签
file_paths = [
    r"D:\md2\2852\results\sasa.xvg",
    r"D:\md2\2852\1_ZINC23258\results\sasa.xvg",
    r"D:\md2\2852\2_5408\results\sasa.xvg",
    r"D:\md2\2852\3_4460729\results\sasa.xvg"
]
...
for file, label, color in zip(file_paths, labels, colors):
    ...
    #plt.plot(clean_time, clean_rmsd, color=color, linewidth=1.5, label=f"{label} ")
...
# 添加图表元素
plt.title("Comparison of SASA Profiles", fontsize=14)

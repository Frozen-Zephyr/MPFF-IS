...
# 定义三个XVG文件路径和对应的标签
file_paths = [
    r"D:\md2\2852\results\rmsd.xvg",
    r"D:\md2\2852\1_ZINC23258\results\rmsd.xvg",
    r"D:\md2\2852\2_5408\results\rmsd.xvg",
    r"D:\md2\2852\3_4460729\results\rmsd.xvg"
]
...
for file, label, color in zip(file_paths, labels, colors):
    ...
    # 绘制原始数据和平滑曲线
    #plt.plot(clean_time, clean_rmsd*10, color=color, alpha=0.3, label=f"{label} ")
    plt.plot(time, rmsd, color=color, linewidth=1, label=f"{label} ")
...
# 添加图表元素
plt.title("Comparison of RMSD Profiles", fontsize=14)

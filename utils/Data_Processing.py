...
input_path = '/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_result.csv'
output_path = '/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/multiple'
...
if __name__ == "__main__":
    while True:
        ...
        if code == 'DUDE':
            ...
            input_dir = "/Volumes/Zephyr's T7/experiment data/完整未筛选数据/zinc"
            output_dir = "/Volumes/Zephyr's T7/experiment data/自定义lipinsiki筛选数据/zinc"
            filter_folder(input_dir, output_dir)
            break

        elif code == 'similar':
            positive_csv ='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_positive.csv'
            experimental_csv='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_result.csv'
            output_csv='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_tanimoto.csv'
            ...
            positive_csv ='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_positive.csv'
            experimental_csv='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_result.csv'
            output_csv='/Users/zephyr/Documents/PycharmProjects/KRASG12D_Inhibitors/Compound_activity_prediction/DataSet/csv/训练conbine/kras data/single/single_distance.csv'
            distance(positive_csv,experimental_csv,output_csv)
            break
